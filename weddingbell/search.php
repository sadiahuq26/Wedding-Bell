<?php include('partials-front/menu.php') ?>;
    ...
    <section class="client-search text-center">
        <div class="container">
            ...
            <h2>Clients on Your Search <a href="#" class="text-white">""</a></h2>
        ...
        <div class="container">
            ...
            <div class="client-menu-box">
                <div class="client-menu-img">
                    <img src="images/pr1.jpg" alt="pr1" class="img-responsive img-curve">
                </div>
                ...
                <div class="client-menu-desc">
                    ...
                    <p class="client-detail">
                        Developer at SoftTech, Cumilla, Muslim.
                    </p>
                    <br>
                </div>
            </div>
